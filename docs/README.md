...
| [Class Diagrams](class_diagrams.md) | Domain model 28 class và 13 enumeration theo module, design class diagram của vertical slice "Advance application", và pattern 3-layer dùng chung cho mọi module | Proposed · Supporting |
